...
def main(arguments):
    ...
    pipeline = StableDiffusion3Pipeline.from_pretrained(model, torch_dtype=datatype)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", default="stabilityai/stable-diffusion-3-medium-diffusers", required=False)
